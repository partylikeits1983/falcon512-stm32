...
export function DeveloperPanel() {
  ...
  const addPacket = (
    ...
    setPackets((prev) => {
      const newPackets = [{ timestamp, direction, data, description }, ...prev];
      ...
      <div style={styles.card}>
        ...
        <div style={styles.controls}>
          ...
          <div style={styles.maxLogsControl}>
            ...
            <input
              ...
              value={maxLogs}
              onChange={(e) =>
                setMaxLogs(Math.max(10, parseInt(e.target.value) || 50))
              }
        ...
        <div style={styles.infoBox}>
          <p style={styles.infoText}>
            <strong>ℹ️ About:</strong> This panel shows raw USB packets
            exchanged with the STM32 device. Useful for debugging communication
            issues.
          </p>
        </div>
        ...
        <div style={styles.logsContainer}>
          ...
          {packets.length === 0 ? (
            <div style={styles.emptyState}>
              No packets logged yet. Connect to device and perform operations to
              see logs.
            </div>
          ) : (
              ...
              {packets.map((packet, idx) => (
                ...
                >
                  ...
                  <div style={styles.logData}>
                    <div style={styles.logDataLabel}>
                      Hex ({packet.data.length} bytes):
                    </div>
                    <code style={styles.logDataHex}>
                      {bytesToHex(packet.data, false)}
                    </code>
                  </div>
                  <div style={styles.logData}>
        ...
        <div style={styles.protocolInfo}>
          ...
          <div style={styles.protocolFormat}>
            ...
            <code style={styles.protocolFormatCode}>
              START (1) | CMD (1) | LEN_HIGH (1) | LEN_LOW (1) | PAYLOAD (N) |
              CRC8 (1)
            </code>
          </div>
        </div>
