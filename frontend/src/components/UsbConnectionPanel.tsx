...
export function UsbConnectionPanel({ onConnectionChange }: UsbConnectionPanelProps) {
        ...
        <div style={styles.card}>
          ...
          <div style={{ ...styles.alert, ...styles.alertError }}>
            ...
            <p style={styles.alertText}>
              ...
              <code style={styles.code}>chrome://flags/#enable-experimental-web-platform-features</code>
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.buttonContainer}>
          {status === 'disconnected' || status === 'error' ? (
            ...
            <button
              style={{ ...styles.buttonPrimary, opacity: 0.6 }}
              disabled
            >
              Connecting...
            </button>
